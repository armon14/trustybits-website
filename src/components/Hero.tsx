        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4">
              <Button variant="default" size="xl" className="group" onClick={() => window.open("https://discord.gg/mbGFztSxnT", "_blank")}>
              ...
              <div className="relative">
                ...
                <div className="glass-card rounded-lg p-6 backdrop-blur-xl relative z-10 animate-float shadow-neon-blue">
                  ...
                  <div className="p-2 border border-cyber-blue/20 rounded-md bg-cyber-black/50 mb-4">
                    ...
                    <div className="font-medieval text-xl text-center py-2 text-medieval-gold">Live Events</div>
